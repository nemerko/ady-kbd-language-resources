---
# ─── identity ───────────────────────────────────────────────
id: ady-Cyrl-alphabet
title: "Adyghe (ady) Cyrillic Alphabet"
...
# ─── provenance and use ─────────────────────────────────────
based-on: >
  Unicode CLDR main and auxiliary exemplar sets for ady, prepared and
...
license: CC-BY-4.0
summary: >
  The letters of the Adyghe Cyrillic alphabet in alphabetical order, with their
...
cite-as: >
  Nemlioğlu, M. U. (2026). Adyghe (ady) Cyrillic Alphabet (Version 1.0.0)
  [Data set]. ady-kbd-language-resources.
  https://github.com/nemerko/ady-kbd-language-resources
machine-readable: ady-Cyrl-alphabet.json
related:
  - kbd-Cyrl-alphabet
...
> | | |
> |---|---|
> | **Identifier** | `ady-Cyrl-alphabet` |
> | **Type** | Alphabet |
> | **Version** | 1.0.0 — 2026-09-15 |
> | **Status** | Stable |
> | **Language** | Adyghe (`ady`) |
> | **Script** | Cyrillic (`Cyrl`) |
> | **Letters** | 66 in the main exemplar, 3 auxiliary |
> | **Author** | M. Uğur Nemlioğlu ([ORCID](https://orcid.org/0000-0002-1969-2356)) |
> | **Reviewer** | Saida Abregova Nemlioğlu — letter forms and alphabetical order |
> | **Licence** | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
>
> **Cite as —** Nemlioğlu, M. U. (2026). *Adyghe (ady) Cyrillic Alphabet*
...
This file records two things: **which letters belong to the Adyghe Cyrillic
...
`ady-Cyrl-ipa` *(not yet published)* — and it does not map the letters onto any
...
The alphabetical order of Adyghe is the one recorded here, and only here.
...
| 2 | `б` | U+0431 | `Б` | U+0411 | `Б` | U+0411 | single |
| 3 | `в` | U+0432 | `В` | U+0412 | `В` | U+0412 | single |
| 4 | `г` | U+0433 | `Г` | U+0413 | `Г` | U+0413 | single |
| 5 | `{гу}` | U+0433+U+0443 | `Гу` | U+0413+U+0443 | `ГУ` | U+0413+U+0423 | digraph |
| 6 | `{гъ}` | U+0433+U+044A | `Гъ` | U+0413+U+044A | `ГЪ` | U+0413+U+042A | digraph |
| 7 | `{гъу}` | U+0433+U+044A+U+0443 | `Гъу` | U+0413+U+044A+U+0443 | `ГЪУ` | U+0413+U+042A+U+0423 | trigraph |
| 8 | `д` | U+0434 | `Д` | U+0414 | `Д` | U+0414 | single |
| 9 | `{дж}` | U+0434+U+0436 | `Дж` | U+0414+U+0436 | `ДЖ` | U+0414+U+0416 | digraph |
| 10 | `{дз}` | U+0434+U+0437 | `Дз` | U+0414+U+0437 | `ДЗ` | U+0414+U+0417 | digraph |
| 11 | `{дзу}` | U+0434+U+0437+U+0443 | `Дзу` | U+0414+U+0437+U+0443 | `ДЗУ` | U+0414+U+0417+U+0423 | trigraph |
| 12 | `е` | U+0435 | `Е` | U+0415 | `Е` | U+0415 | single |
| 13 | `ё` | U+0451 | `Ё` | U+0401 | `Ё` | U+0401 | single |
| 14 | `ж` | U+0436 | `Ж` | U+0416 | `Ж` | U+0416 | single |
| 15 | `{жъ}` | U+0436+U+044A | `Жъ` | U+0416+U+044A | `ЖЪ` | U+0416+U+042A | digraph |
| 16 | `{жъу}` | U+0436+U+044A+U+0443 | `Жъу` | U+0416+U+044A+U+0443 | `ЖЪУ` | U+0416+U+042A+U+0423 | trigraph |
| 17 | `{жь}` | U+0436+U+044C | `Жь` | U+0416+U+044C | `ЖЬ` | U+0416+U+042C | digraph |
| 18 | `з` | U+0437 | `З` | U+0417 | `З` | U+0417 | single |
| 19 | `и` | U+0438 | `И` | U+0418 | `И` | U+0418 | single |
| 20 | `й` | U+0439 | `Й` | U+0419 | `Й` | U+0419 | single |
| 21 | `к` | U+043A | `К` | U+041A | `К` | U+041A | single |
| 22 | `{ку}` | U+043A+U+0443 | `Ку` | U+041A+U+0443 | `КУ` | U+041A+U+0423 | digraph |
...
| 25 | `{кӏ}` | U+043A+U+04CF | `Кӏ` | U+041A+U+04CF | `КӀ` | U+041A+U+04C0 | digraph |
| 26 | `{кӏу}` | U+043A+U+04CF+U+0443 | `Кӏу` | U+041A+U+04CF+U+0443 | `КӀУ` | U+041A+U+04C0+U+0423 | trigraph |
...
| 35 | `{пӏу}` | U+043F+U+04CF+U+0443 | `Пӏу` | U+041F+U+04CF+U+0443 | `ПӀУ` | U+041F+U+04C0+U+0423 | trigraph |
| 36 | `р` | U+0440 | `Р` | U+0420 | `Р` | U+0420 | single |
| 37 | `с` | U+0441 | `С` | U+0421 | `С` | U+0421 | single |
| 38 | `т` | U+0442 | `Т` | U+0422 | `Т` | U+0422 | single |
| 39 | `{тӏ}` | U+0442+U+04CF | `Тӏ` | U+0422+U+04CF | `ТӀ` | U+0422+U+04C0 | digraph |
| 40 | `{тӏу}` | U+0442+U+04CF+U+0443 | `Тӏу` | U+0422+U+04CF+U+0443 | `ТӀУ` | U+0422+U+04C0+U+0423 | trigraph |
| 41 | `у` | U+0443 | `У` | U+0423 | `У` | U+0423 | single |
| 42 | `ф` | U+0444 | `Ф` | U+0424 | `Ф` | U+0424 | single |
| 43 | `х` | U+0445 | `Х` | U+0425 | `Х` | U+0425 | single |
| 44 | `{хъ}` | U+0445+U+044A | `Хъ` | U+0425+U+044A | `ХЪ` | U+0425+U+042A | digraph |
| 45 | `{хъу}` | U+0445+U+044A+U+0443 | `Хъу` | U+0425+U+044A+U+0443 | `ХЪУ` | U+0425+U+042A+U+0423 | trigraph |
| 46 | `{хь}` | U+0445+U+044C | `Хь` | U+0425+U+044C | `ХЬ` | U+0425+U+042C | digraph |
| 47 | `ц` | U+0446 | `Ц` | U+0426 | `Ц` | U+0426 | single |
| 48 | `{цу}` | U+0446+U+0443 | `Цу` | U+0426+U+0443 | `ЦУ` | U+0426+U+0423 | digraph |
| 49 | `{цӏ}` | U+0446+U+04CF | `Цӏ` | U+0426+U+04CF | `ЦӀ` | U+0426+U+04C0 | digraph |
| 50 | `ч` | U+0447 | `Ч` | U+0427 | `Ч` | U+0427 | single |
| 51 | `{чъ}` | U+0447+U+044A | `Чъ` | U+0427+U+044A | `ЧЪ` | U+0427+U+042A | digraph |
| 52 | `{чӏ}` | U+0447+U+04CF | `Чӏ` | U+0427+U+04CF | `ЧӀ` | U+0427+U+04C0 | digraph |
| 53 | `ш` | U+0448 | `Ш` | U+0428 | `Ш` | U+0428 | single |
| 54 | `{шъ}` | U+0448+U+044A | `Шъ` | U+0428+U+044A | `ШЪ` | U+0428+U+042A | digraph |
| 55 | `{шъу}` | U+0448+U+044A+U+0443 | `Шъу` | U+0428+U+044A+U+0443 | `ШЪУ` | U+0428+U+042A+U+0423 | trigraph |
| 56 | `{шӏ}` | U+0448+U+04CF | `Шӏ` | U+0428+U+04CF | `ШӀ` | U+0428+U+04C0 | digraph |
| 57 | `{шӏу}` | U+0448+U+04CF+U+0443 | `Шӏу` | U+0428+U+04CF+U+0443 | `ШӀУ` | U+0428+U+04C0+U+0423 | trigraph |
| 58 | `щ` | U+0449 | `Щ` | U+0429 | `Щ` | U+0429 | single |
| 59 | `ъ` | U+044A | `Ъ` | U+042A | `Ъ` | U+042A | single |
| 60 | `ы` | U+044B | `Ы` | U+042B | `Ы` | U+042B | single |
| 61 | `ь` | U+044C | `Ь` | U+042C | `Ь` | U+042C | single |
| 62 | `э` | U+044D | `Э` | U+042D | `Э` | U+042D | single |
| 63 | `ю` | U+044E | `Ю` | U+042E | `Ю` | U+042E | single |
| 64 | `я` | U+044F | `Я` | U+042F | `Я` | U+042F | single |
| 65 | `ӏ` | U+04CF | `Ӏ` | U+04C0 | `Ӏ` | U+04C0 | single |
| 66 | `{ӏу}` | U+04CF+U+0443 | `Ӏу` | U+04C0+U+0443 | `ӀУ` | U+04C0+U+0423 | digraph |
...
|---|---|---|---|---|---|---|---|
| 1 | `{гь}` | U+0433+U+044C | `Гь` | U+0413+U+044C | `ГЬ` | U+0413+U+042C | Shapsug |
| 2 | `{кь}` | U+043A+U+044C | `Кь` | U+041A+U+044C | `КЬ` | U+041A+U+042C | Shapsug |
| 3 | `{кӏь}` | U+043A+U+04CF+U+044C | `Кӏь` | U+041A+U+04CF+U+044C | `КӀЬ` | U+041A+U+04C0+U+042C | Shapsug |
...
Unicode CLDR, exemplar characters for `ady`. Prepared and maintained by the
...
> `ady-Cyrl-alphabet` · v1.0.0 · 2026-09-15 ·
